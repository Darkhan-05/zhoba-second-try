/*
  ...
  - You are about to drop the column `sessionId` on the `Answer` table. All the data in the column will be lost.
...
INSERT INTO "new_Answer" ("content", "createdAt", "hatColor", "id", "studentName") SELECT "content", "createdAt", "hatColor", "id", "studentName" FROM "Answer";
DROP TABLE "Answer";
